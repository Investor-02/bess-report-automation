...
export function calculateFcrMonitoringFromPath(filePath: string): FcrMonitoringResult {
  const workbook = XLSX.read(fs.readFileSync(filePath), { type: 'buffer', sheetStubs: true });
